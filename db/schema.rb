...
ActiveRecord::Schema.define(:version => 20140220140607) do
  ...
  add_index "blast_iterations", ["seqfeature_id"], :name => "index_blast_iterations_on_seqfeature_id"
  ...
  add_index "hits", ["blast_iteration_id"], :name => "index_hits_on_blast_iteration_id"
  ...
  create_table "hsps", :force => true do |t|
    ...
    t.integer "hit_from"
    t.integer "hit_to"
    t.integer "query_frame"
    t.integer "hit_frame"
    t.integer "identity"
    t.integer "positive"
    t.integer "gaps"
    t.integer "align_length"
    t.string  "evalue"
    t.text    "query_seq"
    t.text    "hit_seq"
    t.text    "midline"
