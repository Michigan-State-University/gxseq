...
ActiveRecord::Schema.define(:version => 20120801181239) do
  ...
  create_table "bioentry", :primary_key => "bioentry_id", :force => true do |t|
    t.integer  "taxon_version_id", :limit => 10,   :precision => 10, :scale => 0, :null => false
  ...
  add_index "bioentry", ["taxon_version_id", "accession", "biodatabase_id", "version"], :name => "bioentry_idx", :unique => true
  add_index "bioentry", ["taxon_version_id", "identifier", "biodatabase_id", "version"], :name => "bioentry_idx_1", :unique => true
  ...
  create_table "experiments", :force => true do |t|
    t.integer  "bioentry_id",                     :precision => 38, :scale => 0
    t.integer  "taxon_version_id",                :precision => 38, :scale => 0
    t.integer  "user_id",                         :precision => 38, :scale => 0
    t.string   "name"
    t.string   "type"
  ...
  create_table "taxon", :primary_key => "taxon_id", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "left_value",                      :precision => 38, :scale => 0
    t.integer  "right_value",                     :precision => 38, :scale => 0
  end
  ...
  add_index "taxon_versions", ["version"], :name => "i_taxon_versions_version", :unique => true
  ...
  add_index "term", ["identifier"], :name => "term_idx", :unique => true
