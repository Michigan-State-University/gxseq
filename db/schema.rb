...
ActiveRecord::Schema.define(:version => 20130924185112) do
  ...
  add_index "biodatabase", ["name"], :name => "biodatabase_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "bioentry_path", ["object_bioentry_id", "subject_bioentry_id", "term_id", "distance"], :name => "bioentry_path_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "bioentry_qualifier_value", ["bioentry_id", "term_id", "rank"], :name => "bioentry_qualifier_value_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "bioentry_relationship", ["object_bioentry_id", "subject_bioentry_id", "term_id"], :name => "bioentry_relationship_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "biosequence", ["bioentry_id", "version"], :name => "bioseq_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  create_table "blast_iterations", :force => true do |t|
    ...
    t.integer "query_len",                     :precision => 38, :scale => 0
  end
  ...
  add_index "comments", ["bioentry_id", "rank"], :name => "comments_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "dbxref", ["accession", "dbname", "version"], :name => "dbxref_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "delayed_jobs", ["priority", "run_at"], :name => "delayed_jobs_priority", :tablespace => "gs_rtsf_dev"
  ...
  add_index "experiments", ["assembly_id", "group_id", "user_id"], :name => "experiment_idx1", :tablespace => "gs_rtsf_dev"
  ...
  add_index "feature_counts", ["experiment_id", "seqfeature_id"], :name => "idx_exp_and_feature", :tablespace => "gs_rtsf_dev"
  add_index "feature_counts", ["seqfeature_id"], :name => "idx_feature", :tablespace => "gs_rtsf_dev"
  ...
  add_index "gene_models", ["bioentry_id"], :name => "gene_models_idx_3", :tablespace => "gs_rtsf_dev"
  add_index "gene_models", ["cds_id"], :name => "gene_models_idx_1", :tablespace => "gs_rtsf_dev"
  add_index "gene_models", ["gene_id"], :name => "gene_models_idx", :tablespace => "gs_rtsf_dev"
  add_index "gene_models", ["mrna_id"], :name => "gene_models_idx_2", :tablespace => "gs_rtsf_dev"
  ...
  add_index "groups_users", ["group_id", "user_id"], :name => "groups_users_idx1", :tablespace => "gs_rtsf_dev"

  create_table "hits", :force => true do |t|
    t.integer "blast_iteration_id",                 :precision => 38, :scale => 0
    t.string  "blast_hit_id"
    t.string  "accession"
    t.string  "definition",         :limit => 4000
    t.integer "length",                             :precision => 38, :scale => 0
    t.integer "hit_num",                            :precision => 38, :scale => 0
  end
  ...
  add_index "location", ["seqfeature_id", "rank"], :name => "location_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  add_index "location", ["seqfeature_id"], :name => "location_idx_1", :tablespace => "gs_rtsf_dev"
  ...
  add_index "ontology", ["name"], :name => "ontology_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "preferences", ["owner_id", "owner_type", "name", "group_id", "group_type"], :name => "owner_name_group_pref_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "reference", ["crc"], :name => "reference_idx_1", :unique => true, :tablespace => "gs_rtsf_dev"
  add_index "reference", ["dbxref_id"], :name => "reference_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "roles_users", ["role_id"], :name => "index_roles_users_on_role_id", :tablespace => "gs_rtsf_dev"
  add_index "roles_users", ["user_id"], :name => "index_roles_users_on_user_id", :tablespace => "gs_rtsf_dev"
  ...
  add_index "seqfeature", ["bioentry_id", "type_term_id", "source_term_id", "rank"], :name => "seqfeature_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  add_index "seqfeature", ["display_name"], :name => "seqfeature_idx_1", :tablespace => "gs_rtsf_dev"
  add_index "seqfeature", ["type_term_id", "seqfeature_id"], :name => "idx_type_term", :tablespace => "gs_rtsf_dev"
  ...
  add_index "seqfeature_path", ["object_seqfeature_id", "subject_seqfeature_id", "term_id", "distance"], :name => "seqfeature_path_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "seqfeature_qualifier_value", ["seqfeature_id", "term_id", "rank"], :name => "sqv_idx_2", :unique => true, :tablespace => "gs_rtsf_dev"
  add_index "seqfeature_qualifier_value", ["seqfeature_id"], :name => "sqv_idx", :tablespace => "gs_rtsf_dev"
  add_index "seqfeature_qualifier_value", ["term_id"], :name => "sqv_idx_1", :tablespace => "gs_rtsf_dev"
  add_index "seqfeature_qualifier_value", ["value"], :name => "sqv_idx_3", :tablespace => "gs_rtsf_dev"
  ...
  add_index "seqfeature_relationship", ["object_seqfeature_id", "subject_seqfeature_id", "term_id"], :name => "seqfeature_relationship_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "sequence_files", ["assembly_id"], :name => "i_sequence_files_assembly_id", :tablespace => "gs_rtsf_dev"
  ...
  add_index "sequence_variants", ["bioentry_id", "pos"], :name => "seq_variant_idx_4", :tablespace => "gs_rtsf_dev"
  add_index "sequence_variants", ["experiment_id", "bioentry_id", "pos"], :name => "seq_variant_idx_2", :tablespace => "gs_rtsf_dev"
  add_index "sequence_variants", ["experiment_id", "bioentry_id"], :name => "seq_variant_idx_1", :tablespace => "gs_rtsf_dev"
  add_index "sequence_variants", ["experiment_id", "pos"], :name => "seq_variant_idx", :tablespace => "gs_rtsf_dev"
  ...
  add_index "sessions", ["session_id"], :name => "index_sessions_on_session_id", :tablespace => "gs_rtsf_dev"
  add_index "sessions", ["updated_at"], :name => "index_sessions_on_updated_at", :tablespace => "gs_rtsf_dev"
  ...
  add_index "taxon", ["left_value"], :name => "taxon_idx_1", :unique => true, :tablespace => "gs_rtsf_dev"
  add_index "taxon", ["ncbi_taxon_id"], :name => "taxon_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  add_index "taxon", ["right_value"], :name => "taxon_idx_2", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "taxon_name", ["name"], :name => "taxon_name_idx2", :tablespace => "gs_rtsf_dev"
  add_index "taxon_name", ["taxon_id", "name", "name_class"], :name => "taxon_name_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "term", ["name", "ontology_id", "is_obsolete"], :name => "term_idx_1", :unique => true, :tablespace => "gs_rtsf_dev"
  add_index "term", ["name"], :name => "term_idx_2", :tablespace => "gs_rtsf_dev"
  ...
  add_index "term_path", ["subject_term_id", "predicate_term_id", "object_term_id", "ontology_id", "distance"], :name => "term_path_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "term_relationship", ["subject_term_id", "predicate_term_id", "object_term_id", "ontology_id"], :name => "term_relationship_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "term_relationship_term", ["term_id"], :name => "term_relationship_term_idx", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "users", ["confirmation_token"], :name => "i_users_confirmation_token", :unique => true, :tablespace => "gs_rtsf_dev"
  add_index "users", ["email"], :name => "index_users_on_email", :unique => true, :tablespace => "gs_rtsf_dev"
  add_index "users", ["login"], :name => "index_users_on_login", :unique => true, :tablespace => "gs_rtsf_dev"
  add_index "users", ["unlock_token"], :name => "index_users_on_unlock_token", :unique => true, :tablespace => "gs_rtsf_dev"
  ...
  add_index "versions", ["item_type", "item_id"], :name => "i_versions_item_type_item_id", :tablespace => "gs_rtsf_dev"
  add_index "versions", ["parent_type", "parent_id", "item_type"], :name => "i_ver_par_typ_par_id_ite_typ", :tablespace => "gs_rtsf_dev"
